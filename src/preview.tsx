  ...
  return (
    <main className="preview-page">
      <motion.nav className="preview-nav" initial={reducedMotion ? undefined : { opacity: 0, y: -10 }} animate={reducedMotion ? undefined : { opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}>
        ...
        <div className="preview-nav-links"><a href="#courses">Explore</a><a href="#about">Membership</a><a href="#about">For teams</a><a href="#about">Enterprise</a><a href="#about">Blog</a><a href="#about">About</a><span className="preview-nav-status"><span className="skillpath-signal-dot skillpath-signal-dot-mint" /> System live</span><a className="preview-nav-login" href="#about">Log in</a><a className="preview-nav-cta" href="#courses">Start free <span aria-hidden="true">↗</span></a></div>
      </motion.nav>
