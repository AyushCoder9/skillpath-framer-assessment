...
function LiveOrbit() {
  ...
  return (
    <div className="preview-orbit-stage" aria-hidden="true" onPointerMove={handlePointerMove} onPointerLeave={resetPointer}>
      ...
      <motion.div className="preview-hero-orbit-card" style={reducedMotion ? undefined : { x: cardX, y: cardY, rotateX: cardRotateX, rotateY: cardRotateY }}>
        <div className="preview-orbit-card-top"><strong>skillpath / live index</strong><span className="preview-orbit-card-status"><span className="skillpath-signal-dot" /> interface concept</span></div>
        <div className="preview-orbit-card-body">
          ...
          <div className="preview-orbit-results">
            ...
            <div className="preview-orbit-cards">
              {[['Course signal', 'Preview · live'], ['Useful systems', 'Preview · live'], ['Next practice', 'Preview · live']].map(([title, category]) => (
